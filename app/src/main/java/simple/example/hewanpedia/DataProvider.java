...
public class DataProvider {
    ...
    private static List<Burung> initDataBurung(Context ctx){
        ...
        burungs.add(new Burung(ctx.getString(R.string.cendrawasih_nama), ctx.getString(R.string.crndrawasih_asal),
                ctx.getString(R.string.cendrawasih_deskripsi), R.drawable.bird_cendrawasih));
        burungs.add(new Burung(ctx.getString(R.string.flamingo_nama), ctx.getString(R.string.flamingo_asal),
                ctx.getString(R.string.flamingo_deskripsi), R.drawable.bird_flamingo));
        burungs.add(new Burung(ctx.getString(R.string.golden_pheasant_nama), ctx.getString(R.string.golden_pheasant_asal),
                ctx.getString(R.string.golden_pheasant_deskripsi), R.drawable.bird_golden_pheasant));
        burungs.add(new Burung(ctx.getString(R.string.macau_nama), ctx.getString(R.string.macau_asal),
                ctx.getString(R.string.macau_deskripsi), R.drawable.bird_macau));
        burungs.add(new Burung(ctx.getString(R.string.merak_nama), ctx.getString(R.string.merak_asal),
                ctx.getString(R.string.merak_deskripsi), R.drawable.bird_merak));
        burungs.add(new Burung(ctx.getString(R.string.tucan_nama), ctx.getString(R.string.tucan_asal),
                ctx.getString(R.string.tucan_deskripsi), R.drawable.bird_tucan));
        return burungs;
    }
